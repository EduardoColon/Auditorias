...
namespace ProyectoIngenieriaSoftware.Mantenimientos
{
    ...
    public partial class frmInvenIp : Form
    {
        ...
        public frmInvenIp(OdbcConnection con)
        {
            InitializeComponent();
            this.con = con;
        ...
        void ActualizarGrid()
        {
            try
            {
                ...
                string sRecuperarClientes = "SELECT tbl_activo.PK_idActivo" +
                    ...
                    "ON tbl_activo.PK_idActivo = tbl_inventario_soporte_tecnico_ip.PK_idActivo where tbl_activo.estado = 1";
        ...
        private void btn_buscar_Click(object sender, EventArgs e)
        {
            ...
            string sBuscar = "SELECT tbl_activo.PK_idActivo" +
                    ...
                    " FROM tbl_activo INNER JOIN tbl_inventario_soporte_tecnico_ip " +
                    "ON tbl_activo.PK_idActivo = tbl_inventario_soporte_tecnico_ip.PK_idActivo WHERE tbl_activo.PK_idActivo LIKE '%" + txt_buscar.Text + "%' ";
